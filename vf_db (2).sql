...
--
-- Host: localhost    Database: vinfast_db_new
-- ------------------------------------------------------
...
CREATE TABLE `consultation_requests` (
  ...
  `note` text,
  `staff_id` varchar(255) DEFAULT NULL COMMENT 'Nhân viên xử lý',
  `response_note` text COMMENT 'Ghi chú kết quả',
  PRIMARY KEY (`id`),
  KEY `variant_id` (`variant_id`),
  KEY `FK_consultation_requests_showroom` (`showroom_id`),
  KEY `fk_consult_staff` (`staff_id`),
  CONSTRAINT `consultation_requests_ibfk_1` FOREIGN KEY (`variant_id`) REFERENCES `car_variants` (`id`),
  CONSTRAINT `fk_consult_staff` FOREIGN KEY (`staff_id`) REFERENCES `user` (`id`),
...
INSERT INTO `consultation_requests` VALUES (12,'dsfs','1234567890','Hà Nội',6,'Đã đặt cọc','2025-12-27 10:04:00.000000',2,'2025-12-26 01:00:48.371352','hdg@gmail.com','sdasd','8f85a906-30db-433f-b50e-0874db3eefa8',NULL),(13,'Nông Thế Hưng2','9872651134','Hà Nội',2,'Đang liên hệ','2026-01-01 00:16:00.000000',2,'2025-12-26 03:13:03.348861','hung123@gmail.com','Lái thử','8f85a906-30db-433f-b50e-0874db3eefa8',NULL),(14,'fsd','0987654321','Hà Nội',3,'Đang liên hệ','2026-01-07 01:40:00.000000',3,'2025-12-26 03:35:26.961697','dsa34@gmail.com','123','8f85a906-30db-433f-b50e-0874db3eefa8',NULL),(15,'Nông Thế Hưng 3','123425345','Đà Nẵng',3,'Đang liên hệ','2025-12-27 01:35:00.000000',8,'2025-12-26 04:32:28.228915','acvc@gmai.com','Đi chơi','8f85a906-30db-433f-b50e-0874db3eefa8',NULL);
...
CREATE TABLE `contracts` (
  ...
  `customer_info_snapshot` json DEFAULT NULL,
  ...
  CONSTRAINT `contracts_ibfk_1` FOREIGN KEY (`deposit_id`) REFERENCES `deposits` (`id`),
  CONSTRAINT `contracts_ibfk_2` FOREIGN KEY (`created_by`) REFERENCES `user` (`id`)
...
CREATE TABLE `deposits` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `user_id` varchar(255) NOT NULL COMMENT 'Khách hàng đặt cọc',
  `variant_id` bigint NOT NULL COMMENT 'Phiên bản xe chọn mua',
  `showroom_id` int DEFAULT NULL COMMENT 'Showroom nhận xe',
  `selected_color` varchar(255) DEFAULT NULL COMMENT 'Màu xe khách chọn',
  `amount` decimal(38,2) NOT NULL COMMENT 'Số tiền cọc',
  `status` varchar(255) DEFAULT NULL,
  `payment_method` varchar(255) DEFAULT NULL,
  `staff_id` varchar(255) DEFAULT NULL COMMENT 'Nhân viên phụ trách đơn này',
  `note` text COMMENT 'Ghi chú của khách hàng',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `customer_name` varchar(255) DEFAULT NULL COMMENT 'Tên khách hàng lúc đặt cọc',
  `phone` varchar(255) DEFAULT NULL,
  `email` varchar(255) DEFAULT NULL COMMENT 'Email lúc đặt cọc',
  ...
  CONSTRAINT `deposits_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `deposits_ibfk_2` FOREIGN KEY (`variant_id`) REFERENCES `car_variants` (`id`),
  CONSTRAINT `deposits_ibfk_3` FOREIGN KEY (`showroom_id`) REFERENCES `showrooms` (`id`),
  CONSTRAINT `deposits_ibfk_4` FOREIGN KEY (`staff_id`) REFERENCES `user` (`id`)
...
INSERT INTO `deposits` VALUES (8,'user-uuid-003',1,5,'Brahminy White',10000000.00,'APPROVED','VNPAY',NULL,'đá','2025-12-26 00:47:19','2025-12-26 00:49:45',NULL,NULL,NULL,NULL),(9,'user-uuid-003',1,4,'Brahminy White',10000000.00,'APPROVED','VNPAY',NULL,'','2025-12-26 02:25:19','2025-12-26 02:26:34',NULL,NULL,NULL,NULL),(10,'user-uuid-003',4,10,'Brahminy White',50000000.00,'REJECTED','VNPAY',NULL,'Không','2025-12-26 03:13:39','2025-12-26 03:37:08',NULL,NULL,NULL,NULL),(11,'user-uuid-003',6,2,'Brahminy White',50000000.00,'APPROVED','VNPAY',NULL,'','2025-12-26 03:35:58','2025-12-26 04:19:05',NULL,NULL,NULL,NULL),(12,'0dfdcbf2-531d-4b36-a37e-e3fd9ad847d1',1,9,'Brahminy White',10000000.00,'APPROVED','VNPAY',NULL,'có','2025-12-26 06:22:27','2025-12-25 23:38:02','Lê Xuân Kiên','097531434','adfg@gmail.com','3242521414'),(13,'ce69f427-4f17-4df2-a326-0fa7472b5c37',1,5,'Brahminy White',10000000.00,'APPROVED','VNPAY',NULL,'','2025-12-26 06:28:33','2025-12-25 23:36:06','Nông Thế Hưng','0973408720','dfsg@gmail.com','1234567890');
...
CREATE TABLE `master_colors` (
  `id` int NOT NULL AUTO_INCREMENT,
  `code` varchar(50) NOT NULL COMMENT 'Mã màu (VD: BRAHMINY_WHITE)',
  `name` varchar(255) NOT NULL COMMENT 'Tên hiển thị (VD: Brahminy White)',
  `hex_code` varchar(20) NOT NULL COMMENT 'Mã hex hiển thị (VD: #ffffff)',
  PRIMARY KEY (`id`)
...
LOCK TABLES `master_colors` WRITE;
/*!40000 ALTER TABLE `master_colors` DISABLE KEYS */;
INSERT INTO `master_colors` VALUES (1,'WHITE','Brahminy White','#ffffff'),(2,'RED','Crimson Red','#dc2626'),(3,'GREY','Neptune Grey','#6b7280'),(4,'BLUE','VinFast Blue','#2563eb'),(5,'YELLOW','Sunset Yellow','#fbbf24');
/*!40000 ALTER TABLE `master_colors` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `permission` VALUES ('CREATE_DATA','Quyền tạo mới dữ liệu'),('DELETE_DATA','Quyền xóa dữ liệu'),('MANAGE_USER','Quyền quản lý người dùng'),('UPDATE_DATA','Quyền cập nhật dữ liệu'),('VIEW_DATA','Quyền xem dữ liệu');
...
INSERT INTO `role` VALUES ('ADMIN','Admin role'),('MANAGER','Manager role'),('STAFF','Staff role'),('USER','User role');
...
INSERT INTO `role_permissions` VALUES ('ADMIN','CREATE_DATA'),('STAFF','CREATE_DATA'),('ADMIN','DELETE_DATA'),('ADMIN','MANAGE_USER'),('ADMIN','UPDATE_DATA'),('STAFF','UPDATE_DATA'),('ADMIN','VIEW_DATA'),('STAFF','VIEW_DATA'),('USER','VIEW_DATA');
...
CREATE TABLE `system_logs` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `user_id` varchar(255) DEFAULT NULL COMMENT 'Ai thực hiện (có thể null nếu là khách vãng lai)',
  `action` varchar(255) NOT NULL,
  `target_table` varchar(255) DEFAULT NULL,
  `target_id` varchar(255) DEFAULT NULL COMMENT 'ID của đối tượng bị tác động',
  `description` text COMMENT 'Chi tiết thay đổi',
...
INSERT INTO `system_logs` VALUES (1,'hung','LOGIN','user','8f85a906-30db-433f-b50e-0874db3eefa8','Người dùng hung đã đăng nhập thành công.',NULL,'2025-12-26 00:58:05'),(2,'hung345','LOGIN','user','92b7b6eb-1099-4766-850c-6194d14755cd','Người dùng hung345 đã đăng nhập thành công.',NULL,'2025-12-26 00:59:29'),(3,'GUEST (1234567890)','CREATE_CONSULTATION','consultation_requests','12','Khách hàng dsfs đăng ký tư vấn xe EBus',NULL,'2025-12-26 01:00:48'),(4,'concu1','LOGIN','user','544b027a-fcc5-4d94-9a2e-7d254f20d06b','Người dùng concu1 đã đăng nhập thành công.',NULL,'2025-12-26 01:01:57'),(5,'hung','LOGIN','user','8f85a906-30db-433f-b50e-0874db3eefa8','Người dùng hung đã đăng nhập thành công.',NULL,'2025-12-26 01:02:44'),(6,'admin','LOGIN','user','6cd17fa9-9024-4304-ae12-309646143aef','Người dùng admin đã đăng nhập thành công.',NULL,'2025-12-26 01:04:55'),(7,'admin','LOGIN','user','6cd17fa9-9024-4304-ae12-309646143aef','Người dùng admin đã đăng nhập thành công.',NULL,'2025-12-26 01:10:00'),(8,'admin','LOGIN','user','6cd17fa9-9024-4304-ae12-309646143aef','Người dùng admin đã đăng nhập thành công.',NULL,'2025-12-26 01:24:04'),(9,'admin','LOGIN','user','6cd17fa9-9024-4304-ae12-309646143aef','Người dùng admin đã đăng nhập thành công.',NULL,'2025-12-26 02:16:06'),(10,'hung','LOGIN','user','8f85a906-30db-433f-b50e-0874db3eefa8','Người dùng hung đã đăng nhập thành công.',NULL,'2025-12-26 03:14:16'),(11,'hung','ASSIGN','consultation_requests','12','Phân công nhân viên hung cho yêu cầu #12',NULL,'2025-12-26 03:14:52');
...
CREATE TABLE `test_drive_requests` (
  ...
  `driver_license_image` varchar(512) DEFAULT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `variant_id` (`variant_id`),
  KEY `showroom_id` (`showroom_id`),
  KEY `staff_id` (`staff_id`),
  CONSTRAINT `test_drive_requests_ibfk_1` FOREIGN KEY (`variant_id`) REFERENCES `car_variants` (`id`),
  CONSTRAINT `test_drive_requests_ibfk_2` FOREIGN KEY (`showroom_id`) REFERENCES `showrooms` (`id`),
  CONSTRAINT `test_drive_requests_ibfk_3` FOREIGN KEY (`staff_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `transactions` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `deposit_id` bigint NOT NULL,
  `transaction_code` varchar(255) NOT NULL COMMENT 'Mã giao dịch VNPAY',
  ...
  PRIMARY KEY (`id`),
  KEY `deposit_id` (`deposit_id`),
  CONSTRAINT `transactions_ibfk_1` FOREIGN KEY (`deposit_id`) REFERENCES `deposits` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES ('0dfdcbf2-531d-4b36-a37e-e3fd9ad847d1',NULL,'','','$2a$10$ZdAlpWtpXZA9lrDCHhdYouZDcPsTsCoORv5OXh8er0b84oH0Z.rDu','null_1766704947038','NEW',NULL,NULL),('3df4c990-f634-4d25-b1e9-636f8de0a8f5','2010-01-25','Nông','Thế Hưng','$2a$10$09qOyFGJ23eZFysFC4j1YuDBmKev5cKb/kEDw.KIyD7jnxbfgX5Fq','hung2','NEW',NULL,NULL),('544b027a-fcc5-4d94-9a2e-7d254f20d06b','2009-05-13','hưng','văb','$2a$10$MGbREvAt3A5d9CVNhAty3O./OF4RxHZ17FvnQuDm1RvLle14kkcRG','concu1','NEW',NULL,NULL),('6cd17fa9-9024-4304-ae12-309646143aef','2004-08-11','Le','Kien','$2a$10$hirhIj3RTx6sN0B4CEvkIukevneY1rHsZv3hcUsDjf7SKzitOgOZC','admin','NEW',NULL,NULL),('891e3838-edea-488b-ab33-aff766656b3f','2004-08-11','admin','admin','$2a$10$v6Iuj1iPRowbyT1dKa90XuiSCuZAvbhl0lSKEM5vD4IHWBcq8fhAC','kien','NEW',NULL,NULL),('8f85a906-30db-433f-b50e-0874db3eefa8','2004-11-17','Nông ','Thế Hưng','$2a$10$CU8HyGM3IIamcFeEMB33WungHz4Q1V20YKdJ.ZHQYFQYlARim8R0O','hung','NEW',NULL,NULL),('92b7b6eb-1099-4766-850c-6194d14755cd','2008-02-27','hưng','nông','$2a$10$mpdpjEbqYB0OlHEMKS04p.k.CGGAxsJkkO81xJE4sHWo.d0es/5hm','hung345','NEW',NULL,NULL),('991e3838-edea-488b-ab33-aff766656b3f','2004-08-11','xuan','kien','$2a$10$v6Iuj1iPRowbyT1dKa90XuiSCuZAvbhl0lSKEM5vD4IHWBcq8fhAC','xuankien','NEW',NULL,NULL),('b0f6c2fe-2105-4760-808a-bfaa81b3e539','2007-05-24','fs','dfs','$2a$10$hvxy9uN0XtWo02fhv4HAQeog176RYpADA.lJkbh4pkSNvdx5tE2fe','thehung','NEW',NULL,NULL),('bb2dcaa0-7a7a-4d81-b831-b2b173842215','2013-06-11','le','kiên','$2a$10$qAAgHWog.dYcQBIBuM9Umuv2gGiVq9MO2B1QhlrXGbDSRU4LDmg/a','kiien','NEW',NULL,NULL),('ce69f427-4f17-4df2-a326-0fa7472b5c37',NULL,'','jigsfs','$2a$10$6pnme78ooH/Kaj2uUgrgHeXrtl3glgO.jBeUeiM1hIf.cz95Nt9H6','1234567890_1766705312822','NEW','1234567890',NULL),('db9f02d2-b29d-487d-a487-9d11684f0f70','2003-06-11','Hưng','Test  phân công',NULL,'hung6','NEW',NULL,NULL),('user-uuid-002','1995-05-15','Trần','Nhân Viên','$2a$10$8.UnVuG9HHgffUDAlk8qfOpauQIUVvHEOmwuryqkkvSu/m6DAW7y.','staff','NEW',NULL,NULL),('user-uuid-003','2000-10-20','Lê','Khách Hàng','$2a$10$8.UnVuG9HHgffUDAlk8qfOpauQIUVvHEOmwuryqkkvSu/m6DAW7y.','customer1','NEW',NULL,NULL),('user-uuid-004','1998-12-12','Phạm','Văn A','$2a$10$8.UnVuG9HHgffUDAlk8qfOpauQIUVvHEOmwuryqkkvSu/m6DAW7y.','customer2','NEW',NULL,NULL);
...
INSERT INTO `user_roles` VALUES ('6cd17fa9-9024-4304-ae12-309646143aef','ADMIN'),('891e3838-edea-488b-ab33-aff766656b3f','ADMIN'),('8f85a906-30db-433f-b50e-0874db3eefa8','ADMIN'),('92b7b6eb-1099-4766-850c-6194d14755cd','ADMIN'),('8f85a906-30db-433f-b50e-0874db3eefa8','MANAGER'),('3df4c990-f634-4d25-b1e9-636f8de0a8f5','STAFF'),('92b7b6eb-1099-4766-850c-6194d14755cd','STAFF'),('991e3838-edea-488b-ab33-aff766656b3f','STAFF'),('bb2dcaa0-7a7a-4d81-b831-b2b173842215','STAFF'),('user-uuid-002','STAFF'),('544b027a-fcc5-4d94-9a2e-7d254f20d06b','USER'),('b0f6c2fe-2105-4760-808a-bfaa81b3e539','USER'),('bb2dcaa0-7a7a-4d81-b831-b2b173842215','USER'),('db9f02d2-b29d-487d-a487-9d11684f0f70','USER'),('user-uuid-003','USER'),('user-uuid-004','USER');
...
CREATE TABLE `variant_colors` (
  ...
  `image_url` varchar(512) DEFAULT NULL COMMENT 'Ảnh xe theo màu này',
  PRIMARY KEY (`id`),
  KEY `variant_id` (`variant_id`),
  KEY `color_id` (`color_id`),
  CONSTRAINT `fk_vc_color` FOREIGN KEY (`color_id`) REFERENCES `master_colors` (`id`),
  CONSTRAINT `fk_vc_variant` FOREIGN KEY (`variant_id`) REFERENCES `car_variants` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-12-26  6:38:37
