...
INSERT INTO `consultation_requests` VALUES (12,'dsfs','1234567890','Hà Nội',6,'Đang liên hệ','2025-12-27 10:04:00.000000',2,'2025-12-26 01:00:48.371352','hdg@gmail.com','sdasd',NULL,NULL),(13,'Nông Thế Hưng2','9872651134','Hà Nội',2,'Không nghe máy','2026-01-01 00:16:00.000000',2,'2025-12-26 03:13:03.348861','hung123@gmail.com','Lái thử',NULL,NULL),(14,'fsd','0987654321','Hà Nội',3,'Đã hẹn lịch','2026-01-07 01:40:00.000000',3,'2025-12-26 03:35:26.961697','dsa34@gmail.com','123',NULL,NULL);
...
INSERT INTO `deposits` VALUES (8,'user-uuid-003',1,5,'Brahminy White',10000000.00,'APPROVED','VNPAY',NULL,'đá','2025-12-26 00:47:19','2025-12-26 00:49:45'),(9,'user-uuid-003',1,4,'Brahminy White',10000000.00,'APPROVED','VNPAY',NULL,'','2025-12-26 02:25:19','2025-12-26 02:26:34'),(10,'user-uuid-003',4,10,'Brahminy White',50000000.00,'REJECTED','VNPAY',NULL,'Không','2025-12-26 03:13:39','2025-12-26 03:37:08'),(11,'user-uuid-003',6,2,'Brahminy White',50000000.00,'PAID','VNPAY',NULL,'','2025-12-26 03:35:58','2025-12-26 03:36:28');
...
CREATE TABLE `user` (
  ...
  `customer_status` enum('NEW','POTENTIAL','CONTACTED','DEPOSITED','PURCHASED') DEFAULT 'NEW' COMMENT 'Trạng thái chăm sóc',
  `phone` varchar(255) DEFAULT NULL,
  `address` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2025-12-26  4:07:33
