...
INSERT INTO `consultation_requests` VALUES (1,'Nguyễn Văn A','0912345678','Hà Nội',1,'Mới',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,'Le Xuan Kien','0963347562','Hà Nội',3,'Đã hẹn lịch','2025-12-06 01:22:00.000000',2,'2025-11-25 09:19:41.537100','Lexuankien11082004@gmail.com','toi muon lai thu xe',NULL,NULL),(3,'kiên','0963563695','Hà Nội',1,'Đã hẹn lịch','2025-12-18 22:17:00.000000',1,'2025-12-12 19:14:35.569140','lexuankien@gmail.com','',NULL,NULL),(4,'fafaf','0224252527','Hà Nội',3,'Đã hẹn lịch','2025-12-24 01:09:00.000000',2,'2025-12-21 21:06:14.697281','le@gmail.com','vvss',NULL,NULL),(5,'Nông Thế Hưng','0973408720','Hà Nội',11,'Đã hẹn lịch','2025-12-26 05:49:00.000000',2,'2025-12-25 14:46:37.304403','','',NULL,NULL);
...
CREATE TABLE `deposits` (
  ...
  `status` enum('PENDING','PAID','CANCELLED','REFUNDED','CONTRACTED') DEFAULT 'PENDING' COMMENT 'Trạng thái đơn cọc',
  `payment_method` varchar(50) DEFAULT 'VNPAY' COMMENT 'Phương thức thanh toán',
...
CREATE TABLE `system_logs` (
  ...
  `action` varchar(100) NOT NULL COMMENT 'Hành động: LOGIN, CREATE_PRODUCT, UPDATE_STATUS...',
  `target_table` varchar(50) DEFAULT NULL COMMENT 'Tác động lên bảng nào',
...
INSERT INTO `user` VALUES ('6cd17fa9-9024-4304-ae12-309646143aef','2004-08-11','Le','Kien','$2a$10$hirhIj3RTx6sN0B4CEvkIukevneY1rHsZv3hcUsDjf7SKzitOgOZC','admin','NEW',NULL,NULL),('891e3838-edea-488b-ab33-aff766656b3f','2004-08-11','admin','admin','$2a$10$v6Iuj1iPRowbyT1dKa90XuiSCuZAvbhl0lSKEM5vD4IHWBcq8fhAC','kien','NEW',NULL,NULL),('991e3838-edea-488b-ab33-aff766656b3f','2004-08-11','xuan','kien','$2a$10$v6Iuj1iPRowbyT1dKa90XuiSCuZAvbhl0lSKEM5vD4IHWBcq8fhAC','xuankien','NEW',NULL,NULL),('bb2dcaa0-7a7a-4d81-b831-b2b173842215','2013-06-11','le','kiên','$2a$10$qAAgHWog.dYcQBIBuM9Umuv2gGiVq9MO2B1QhlrXGbDSRU4LDmg/a','kiien','NEW',NULL,NULL),('user-uuid-002','1995-05-15','Trần','Nhân Viên','$2a$10$8.UnVuG9HHgffUDAlk8qfOpauQIUVvHEOmwuryqkkvSu/m6DAW7y.','staff','NEW',NULL,NULL),('user-uuid-003','2000-10-20','Lê','Khách Hàng','$2a$10$8.UnVuG9HHgffUDAlk8qfOpauQIUVvHEOmwuryqkkvSu/m6DAW7y.','customer1','NEW',NULL,NULL),('user-uuid-004','1998-12-12','Phạm','Văn A','$2a$10$8.UnVuG9HHgffUDAlk8qfOpauQIUVvHEOmwuryqkkvSu/m6DAW7y.','customer2','NEW',NULL,NULL);
...
INSERT INTO `user_roles` VALUES ('6cd17fa9-9024-4304-ae12-309646143aef','ADMIN'),('891e3838-edea-488b-ab33-aff766656b3f','ADMIN'),('991e3838-edea-488b-ab33-aff766656b3f','STAFF'),('bb2dcaa0-7a7a-4d81-b831-b2b173842215','STAFF'),('user-uuid-002','STAFF'),('bb2dcaa0-7a7a-4d81-b831-b2b173842215','USER'),('user-uuid-003','USER'),('user-uuid-004','USER');
...
-- Dump completed on 2025-12-25 17:47:19
